          ...
          {children.map(child => (
            <div key={child.id} className="border p-4 rounded space-y-2">
              <div className="grid grid-cols-2 gap-3">
                ...
                <div><label>Special needs / allergies</label><input className="w-full px-3 py-2 border rounded" value={child.special} onChange={e=>updateChild(child.id,'special',e.target.value)} /></div>
